...
$sql="INSERT INTO `consumer`(`Orderdate`, `email`, `name`, `mobile`, `address`, `prod_name`, `cost`, `city`, `country`, `state`, `postcode`,`supplierid`) VALUES ('".$date."','".$email."','".$name."','".$mobile."','".$address."','".$prod_name."','".$cost."','".$city."','".$country."','".$state."','".$postcode."','".$supplierid."')" ;
